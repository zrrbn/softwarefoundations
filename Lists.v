...
Theorem app_nil_r : forall l : natlist,
  l ++ [] = l.
Proof.
  induction l as [| n l' IH1'].
  - simpl. reflexivity.
  - simpl. rewrite IH1'. reflexivity. Qed.

Theorem rev_app_distr: forall l1 l2 : natlist,
  rev (l1 ++ l2) = rev l2 ++ rev l1.
Proof.
  intros l1 l2. induction l1 as [| n l1' IH1'].
  - simpl. rewrite -> app_nil_r. reflexivity.
  - simpl. rewrite IH1'. simpl. rewrite -> app_assoc. reflexivity. Qed.
